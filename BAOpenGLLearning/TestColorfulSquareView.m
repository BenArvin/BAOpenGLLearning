...
@interface TestColorfulSquareView() {
}
...
@implementation TestColorfulSquareView
...
- (void)display {
    ...
    const GLchar *vertexShaderSourceChar = (GLchar *)[[NSString stringWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"TestColorfulSquareVertex" ofType:@"glsl"] encoding:NSUTF8StringEncoding error:nil] UTF8String];
    ...
    const GLchar *fragmentShaderSourceChar = (GLchar *)[[NSString stringWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"TestColorfulSquareFragment" ofType:@"glsl"] encoding:NSUTF8StringEncoding error:nil] UTF8String];
